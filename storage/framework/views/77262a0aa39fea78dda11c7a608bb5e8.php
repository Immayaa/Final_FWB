...
<body class="bg-amber-50 min-h-screen text-gray-800">
  ...
  <nav class="bg-white shadow-md py-4 px-6 flex justify-between items-center">
    ...
    <ul class="flex space-x-6 text-sm font-semibold">
      ...
      <li><a href="<?php echo e(route('user.riwayat')); ?>" class="hover:text-orange-500">Riwayat Pesanan</a></li>
      <li><a href="<?php echo e(route('user.profil.edit')); ?>" class="hover:text-orange-500">Profil</a></li>
...
<?php /**PATH D:\laragon\www\siwarmak\resources\views/user/master.blade.php ENDPATH**/ ?>